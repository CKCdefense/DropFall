 ...
 * 같이 켜서 확보한 대역폭 여유를 반응성 쪽에 다시 썼다 — 40으로 올려 지연을 25ms로
 * 줄이면서도, 압축 덕에 무압축 60Hz보다는 여전히 대역폭이 적게 든다. 자기 캐릭터
 * 예측을 구현하면 이 값은 순수하게 "원격 개체 부드러움 vs 대역폭" 트레이드오프로만
 * 남게 되어 인원수 걱정 없이 더 낮출 수 있다.
 */
export const PATCH_RATE = 40;
