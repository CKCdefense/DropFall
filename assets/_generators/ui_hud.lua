...
local BIN      = Color{ r = 0x8A, g = 0x91, b = 0xA0 } -- PANEL_STROKE 계열 금속
local BIN_HI   = Color{ r = 0xB9, g = 0xC0, b = 0xCC }
local BIN_DK   = Color{ r = 0x5A, g = 0x61, b = 0x70 }

local function iconTrash(img)
  fromMask(img, {
    '................',
    '......oooo......',
    '......o..o......',
    ...
    '....ommmmmmo....',
    '....oooooooo....',
  }, { o = OUTLINE, m = BIN, h = BIN_HI, d = BIN_DK })
end
